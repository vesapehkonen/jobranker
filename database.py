    ...
    *,
    ...
    WITH job_data AS (
        SELECT j.job_uid, j.application_status, j.application_status AS status,
               ...
               COALESCE(json_extract(a.structured_json,'$.employment_type'),
                        json_extract(a.ranked_json,'$.job.employment_type')) AS employment_type,
               COALESCE(json_extract(a.structured_json,'$.salary_range'),
                        json_extract(a.ranked_json,'$.job.salary_range')) AS salary_range,
